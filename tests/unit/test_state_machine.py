...
class TestStateMachine:
    ...
    def test_pending_to_running_valid(self):
        """测试：待执行→执行中 正确流转"""
        from claudeflow.workflow.state_machine import StateMachine, TaskStatus
    ...
    def test_invalid_transition_raises_error(self):
        """测试：非法状态跳转被拒绝"""
        from claudeflow.workflow.state_machine import StateMachine, TaskStatus, InvalidTransitionError
...
class TestRetryStrategy:
    ...
    def test_retry_interval_sequence(self):
        ...
        from claudeflow.workflow.state_machine import get_retry_interval
    ...
    def test_retriable_error_types(self):
        """测试：可重试错误类型"""
        from claudeflow.workflow.state_machine import is_retriable
